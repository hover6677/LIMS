...
public class SampleDAO {
    ...
    public static boolean updateSample(Document sampleFound, Document sampleDoc) {
        ...
        try {
            ...
            sampleDoc.replace(SampleKeyEnum.Quanity.toString(),
                    sampleFound.getDouble(SampleKeyEnum.Quanity.toString()) + sampleDoc.getDouble(SampleKeyEnum.Quanity.toString()));
